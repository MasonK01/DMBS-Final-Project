...
<?php
    ...
    $update = "UPDATE rooms SET details='501', price='299' WHERE client='$email'";
    ...
    <div class="container">
      ...
      <div class ="roomdisplay-content">
        <div class ="roomdisplay-content-picture">
          <img src="./image/room_king_balcony.jpg">
        </div>
        <div class="roomdisplay-content-description">
          <p class="roomdisplay-content-title">Room Details: </p>
          <p class="roomdisplay-content-details">King Suite with Balcony: Room #501</p>
    ...
    <div class="container">
          ...
          <tr>
            <td class="roomdisplay-content-table-column1">
              <form class="roomdisplay-roomfeaturesform" method="POST">
                <input type="radio" id="crib" name="roomFeatures" value="10">
                <label for="crib">Crib or Pack and Play</label><br>
                <input type="radio" id="rollawayBed" name="roomFeatures" value="15">
                <label for="rollawayBed">Rollaway Bed</label><br>
                <input type="radio" id="foamPillows" name="roomFeatures" value="5">
                ...
                <input type="radio" id="extraFeatherPillows" name="roomFeatures" value="5">
            ...
            <td class="roomdisplay-content-table-column2">
              <form class="roomdisplay-bathroomfeaturesform" method="POST">
                <input type="radio" id="extraTowels" name="bathroomFeatures" value="5">
                <label for="extraTowels">Extra Towels</label><br>
                <input type="radio" id="extraTowels" name="bathroomFeatures" value="10">
                <label for="extraTowels">Extra Soaps</label><br>
              </form>
            </td>
            <td class="roomdisplay-content-table-column3">
              <form class="roomdisplay-checkinfeaturesform" method="POST">
                <input type="radio" id="earlyCheckIn" name="checkInFeatures" value="10">
      ...
      <div class="container">
        <form class="pricingForm">
          ...
          <div class="sub-heading" id="total"></div><p class="sub-heading" > + $299/night</p>
