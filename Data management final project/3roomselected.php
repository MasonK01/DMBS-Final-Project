...
<?php
    ...
    $update = "UPDATE rooms SET details='236', price='349' WHERE client='$email'";
    ...
    <div class="container">
      ...
      <div class ="roomdisplay-content">
        <div class ="roomdisplay-content-picture">
          <img src="./image/room_queen_double_balcony.jpg" width="1150px">
        </div>
        <div class="roomdisplay-content-description">
          <p class="roomdisplay-content-title">Room Details: </p>
          <p class="roomdisplay-content-details">Two bed Queen Suite with Balcony: Room #236</p>
    ...
    <div class="container">
          ...
          <tr>
            ...
            <td class="roomdisplay-content-table-column2">
              <form class="roomdisplay-bathroomfeaturesform" method="POST">
                <input type="radio" id="extraTowels" name="bathroomFeatures" value="13">
      ...
      <div class="container">
        <form class="pricingForm">
          ...
          <div class="sub-heading" id="total"></div><p class="sub-heading" > + $349/night</p>
